...
create trigger update_invoice_amountDue_insert after insert on invoice_items for each row begin
update invoices
set
  amountDue = (
    select
...
create trigger update_invoice_amountDue_update after
update on invoice_items for each row begin
update invoices
set
  amountDue = (
    select
...
create trigger update_invoice_amountDue_delete after delete on invoice_items for each row begin
update invoices
set
  amountDue = (
    select
